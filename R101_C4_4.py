...
max_num_epochs = 12000 #increased from 6000 to 12000

config = {
        'ims_per_batch': tune.choice([2, 4, 8, 16]), #added 16 to the batch size
        'base_lr': tune.loguniform(1e-5, 1e-3),  #Changed (1e-7, 1e-4) from ver 3 to (1e-5, 1e-3)
